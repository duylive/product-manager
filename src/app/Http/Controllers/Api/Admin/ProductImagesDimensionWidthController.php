...
use VCComponent\Laravel\Product\Transformers\ProductImagesDimensionWidthTransformer;
use VCComponent\Laravel\Product\Validators\ProductImagesDimensionWidthValidator;

use VCComponent\Laravel\Vicoders\Core\Controllers\ApiController;

class ProductImagesDimensionWidthController extends ApiController
{
    protected $repository;
    protected $validator;

    public function __construct(ProductImagesDimensionWidthRepository $repository, ProductImagesDimensionWidthValidator $validator)
    {
        $this->repository  = $repository;
        $this->entity      = $repository->getEntity();
        $this->validator   = $validator;
        $this->transformer = ProductImagesDimensionWidthTransformer::class;
